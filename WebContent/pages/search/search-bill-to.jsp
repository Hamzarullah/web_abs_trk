    ...
    jQuery(document).ready(function(){  
        ...
        $("#dlgCustomerAddress_okButton").click(function(ev) { 
            ...
            if (search_customerAddress_type === "grid" ) {
                ...
                $("#"+id_document+"\\."+id_subdoc+"\\.name",opener.document).val(data_search_customerAddress.customerName);
        ...
        <div class="ui-widget">
            ...
            <table cellpadding="2" cellspacing="2">
                ...
                <tr style="display:none;">
                    <td align="right"></td>
                    <td><s:textfield id="searchCustomerAddresDetailStatus" name="searchCustomerAddresDetailStatus" size="50" value="BillTo"></s:textfield></td>
                </tr>
                <tr style="display: none;">
