    ...
    jQuery(document).ready(function(){  
        ...
        $("#dlgItemCurrentStock_okButton").click(function(ev) { 
            ...
            if (search_itemLocation_type === "grid" ) {
                ...
                $("#"+id_document+"Input_grid",opener.document).jqGrid("setCell", selectedRowID, id_document+"ItemMaterialUnitOfMeasureCode", data_search_itemLocation.itemMaterialUnitOfMeasureCode);
                $("#"+id_document+"Input_grid",opener.document).jqGrid("setCell", selectedRowID, id_document+"ItemMaterialCogsIdr", data_search_itemLocation.itemMaterialCogsIdr);
                $("#"+id_document+"Input_grid",opener.document).jqGrid("setCell", selectedRowID, id_document+"ActualStock", data_search_itemLocation.actualStock);
        ...
        $("#btn_dlg_ItemCurrentStockSearch").click(function(ev) {
            $("#dlgSearch_itemLocation_grid").jqGrid("setGridParam",{url:"master/item-current-stock-by-whm-data?" + $("#frmItemCurrentStockSearch").serialize(), page:1});
...
<s:url id="remoteurlItemCurrentStockSearch" action="" />
        <div class="ui-widget">
            ...
            <table cellpadding="2" cellspacing="2">
                <tr>
                    ...
                    <td><s:textfield id="itemCurrentStockSearchItemCode" name="itemCurrentStockSearchItemCode" placeHolder=" Code"></s:textfield></td>
                </tr>
                <tr>
                    <td align="right">Name</td>
                    <td><s:textfield id="itemCurrentStockSearchItemName" name="itemCurrentStockSearchItemName" size="50" placeHolder=" Name"></s:textfield></td>
                </tr>
                <tr style="display:nones">
                    <td align="right">Warehouse Code</td>
                    <td><s:textfield readonly="true" id="itemCurrentStockSearchWarehouseCode" name="itemCurrentStockSearchWarehouseCode" label="Warehouse Code "></s:textfield></td>
                </tr>
                <tr>
                    <td colspan="2"><sj:a href="#" id="btn_dlg_ItemCurrentStockSearch" button="true">Search</sj:a></td>
                </tr>
                <td align="right">
                    <s:textfield id="itemLocationSearchActiveStatus" name="itemLocationSearchActiveStatus" readonly="false" size="5" style="display:none" value="true"></s:textfield>
                </td>
            </table>
            </s:form>
        </div>
        ...
        <div class="ui-widget ui-widget-content">
            ...
            >
                ...
                />
                <sjg:gridColumn
                    name="itemMaterialUnitOfMeasureCode" index="itemMaterialUnitOfMeasureCode" title="itemUnitOfMeasureCode" width="100" sortable="true" hidden="true"
                />
                <sjg:gridColumn
                    name="itemMaterialCogsIdr" index="itemMaterialCogsIdr" title="itemCogsIdr" width="100" sortable="true" hidden="true"
                />
                <sjg:gridColumn
                    name="actualStock" index="actualStock" title="actualStock" width="100" sortable="true" 
                />
                <sjg:gridColumn
