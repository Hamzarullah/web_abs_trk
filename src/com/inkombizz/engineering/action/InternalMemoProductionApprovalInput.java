...
@Results({
    @Result(name="success", location="engineering/internal-memo-production-approval-input.jsp"),
    @Result(name="redirect", type="redirect", location="../pages/noauthority.jsp")
})
public class InternalMemoProductionApprovalInput extends ActionSupport{
    
    private static final long serialVersionUID = 1L;
    protected HBMSession hbmSession = new HBMSession();
    private InternalMemoProduction internalMemoProductionApproval =new InternalMemoProduction();
...
//            
                ...
                internalMemoProductionApproval = (InternalMemoProduction) hbmSession.hSession.get(InternalMemoProduction.class, internalMemoProductionApproval.getCode());
                internalMemoProductionApproval.setTransactionDate(internalMemoProductionApproval.getTransactionDate());
