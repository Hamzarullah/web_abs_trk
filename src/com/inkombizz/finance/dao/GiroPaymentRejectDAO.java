...
public class GiroPaymentRejectDAO {

    private HBMSession hbmSession;
    
    public GiroPaymentRejectDAO(HBMSession session) {
...
//    FIND HEADER
     public List<GiroPaymentRejectTemp> findData(String code,String bankCode,String remark,String grpNo,String giroNo,String bankName,String refNo,
...
//            
            ...
            List<GiroPaymentRejectTemp> list = (List<GiroPaymentRejectTemp>)hbmSession.hSession.createSQLQuery(
                 "SELECT "
                ...
                .setResultTransformer(Transformers.aliasToBean(GiroPaymentRejectTemp.class))
                .list(); 
...
//    END FIND HEADER
    ...
    public void save(GiroPayment giroPaymentRejected, String MODULECODE) throws Exception {
        
        try {
            hbmSession.hSession.beginTransaction();
            
            giroPaymentRejected.setRejectedBy(BaseSession.loadProgramSession().getUserName());
//            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss",Locale.ENGLISH);
//            String RejectedDate= sdf.format(new Date());
                ...
                hbmSession.hSession.createSQLQuery("UPDATE fin_giro_payment "
                        ...
                        .setParameter("prmCode", giroPaymentRejected.getCode())
                        .setParameter("prmReason", giroPaymentRejected.getReason().getCode())
                        .setParameter("prmRejectedRemark", giroPaymentRejected.getRejectedRemark())
                        .setParameter("prmRejectedDate", new Date())
                        .setParameter("prmRejectedBy", giroPaymentRejected.getRejectedBy())
                        .executeUpdate();
