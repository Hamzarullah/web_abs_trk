...
@Entity
@Table(name = "fin_customer_down_payment_used")
public class CustomerDownPaymentUsed implements Serializable{
    
    private String code="";
    private BigDecimal totalTransactionAmount=new BigDecimal("0.00");
    private BigDecimal usedAmount=new BigDecimal("0.00");
