 ...
 * @author Rayis
 */
public class GiroReceivedInquiryTemp {
    ...
    public String getDueDateTemp() {
        return dueDateTemp;
    }

    public void setDueDateTemp(String dueDateTemp) {
        this.dueDateTemp = dueDateTemp;
    }
