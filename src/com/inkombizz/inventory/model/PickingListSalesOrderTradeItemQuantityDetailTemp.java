...
public class PickingListSalesOrderTradeItemQuantityDetailTemp {
    
    private String code = "";
    private String headerCode = "";
    private String detailCode = "";
    private String packingListSalesOrderTradeItemDetailCode = "";
    private BigDecimal quantity = new BigDecimal ("0.00");
    private BigDecimal conversion = new BigDecimal ("0.00");
    ...
    public String getPackingListSalesOrderTradeItemDetailCode() {
        return packingListSalesOrderTradeItemDetailCode;
    }

    public void setPackingListSalesOrderTradeItemDetailCode(String packingListSalesOrderTradeItemDetailCode) {
        this.packingListSalesOrderTradeItemDetailCode = packingListSalesOrderTradeItemDetailCode;
    }
