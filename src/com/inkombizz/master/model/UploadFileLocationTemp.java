...
public class UploadFileLocationTemp {
    
    private String code="";
    private String name="";
    private String shareFolderCode="";
    ...
    public String getShareFolderCode() {
        return shareFolderCode;
    }

    public void setShareFolderCode(String shareFolderCode) {
        this.shareFolderCode = shareFolderCode;
    }
