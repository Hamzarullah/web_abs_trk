...
@Results({
    @Result(name="success", location="purchasing/purchase-order-update-information.jsp"),
    @Result(name="redirect", type="redirect", location="../pages/noauthority.jsp")
})
public class PurchaseOrderUpdateInformationAction extends ActionSupport {
    ...
    public String execute() {
        try {
            ...
            if (!BaseSession.loadProgramSession().hasAuthority(purchaseOrderBLL.MODULECODE_UPDATE_INFORMATION, EnumAuthorizationString.toString(EnumAuthorizationString.ENUM_AuthorizationString.VIEW), hbmSession)) {
                return "redirect";
            }
