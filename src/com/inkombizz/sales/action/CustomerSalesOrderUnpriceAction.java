...
@Results({
    @Result(name="success", location="sales/customer-sales-order-unprice.jsp"),
    @Result(name="redirect", type="redirect", location="../pages/noauthority.jsp")
})
public class CustomerSalesOrderUnpriceAction extends ActionSupport{
    ...
    public String execute() {
        try {
            CustomerSalesOrderBLL salesOrderUnpriceByCustomerPurchaseOrderBLL = new CustomerSalesOrderBLL(hbmSession);            
            if (!BaseSession.loadProgramSession().hasAuthority(salesOrderUnpriceByCustomerPurchaseOrderBLL.MODULECODE_UNPRICE, EnumAuthorizationString.toString(EnumAuthorizationString.ENUM_AuthorizationString.VIEW), hbmSession)) {
                return "redirect";
            }    
