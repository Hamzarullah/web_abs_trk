...
public class CustomerPurchaseOrderToSalesOrderDAO {
    private HBMSession hbmSession;
    
    public CustomerPurchaseOrderToSalesOrderDAO(HBMSession session) {
    ...
    public int countData(CustomerPurchaseOrder customerPurchaseOrder, String validStatus) {
        try {
            ...
            BigInteger temp = (BigInteger)hbmSession.hSession.createSQLQuery(
                "CALL usp_customer_purchase_order_list_so(:prmFlag,:prmCode,:prmCustomerCode,:prmCustomerName,"
    ...
    public int countDataLookUp(CustomerPurchaseOrder customerPurchaseOrder,Date firstDate,Date lastDate) {
        try {
            BigInteger temp = (BigInteger)hbmSession.hSession.createSQLQuery(
                "CALL usp_customer_purchase_order_list(:prmFlag,:prmCode,:prmCustomerCode,:prmCustomerName,:prmFirstDate,:prmLastDate,0,0)")
                .setParameter("prmFlag", "COUNT")
                .setParameter("prmCode", "%"+customerPurchaseOrder.getCode()+"%")
                .setParameter("prmCustomerCode","%"+customerPurchaseOrder.getCustomerCode() +"%")
                .setParameter("prmCustomerName","%"+customerPurchaseOrder.getCustomerName()+"%")
    ...
    public List<CustomerPurchaseOrder> findDataLookUp(CustomerPurchaseOrder customerPurchaseOrder,Date firstDate,Date lastDate, int from, int to) {
        try {
          
            List<CustomerPurchaseOrder> list = (List<CustomerPurchaseOrder>)hbmSession.hSession.createSQLQuery(
                    "CALL usp_customer_purchase_order_list(:prmFlag,:prmCode,:prmCustomerCode,:prmCustomerName,:prmFirstDate,:prmLastDate,:prmLimitFrom,:prmLimitTo)")                       
                .addScalar("code", Hibernate.STRING)
                .addScalar("custPONo", Hibernate.STRING)
                .addScalar("revision", Hibernate.STRING)
                .addScalar("refCUSTPOCode", Hibernate.STRING) 
    ...
    public List<CustomerPurchaseOrderItemDeliveryDate> findDataItemDeliveryDate(String headerCode) {
        try {
            ...
            List<CustomerPurchaseOrderItemDeliveryDate> list = (List<CustomerPurchaseOrderItemDeliveryDate>)hbmSession.hSession.createSQLQuery(
                ...
                "	sal_customer_purchase_order_item_detail.CustomerPurchaseOrderSortNo AS customerPurchaseOrderSortNo, " +
                "	sal_sales_quotation.RefNo AS refNo " +
    ...
    public CustomerPurchaseOrder findDataGet(String code){
        try {
            CustomerPurchaseOrder customerPurchaseOrder = (CustomerPurchaseOrder)hbmSession.hSession.createSQLQuery(
                    ...
                    "IFNULL(sal_customer_sales_order.Code,'') AS salesOrderCode, " +
                    ...
                    "LEFT JOIN sal_customer_sales_order ON sal_customer_sales_order.CustomerPurchaseOrderCode = sal_customer_purchase_order.code "+
...
//            salesOrder = customerPurchaseOrder;
    ...
    public void revise(CustomerPurchaseOrder customerPurchaseOrder,
        ...
        try {
            ...
            salesOrderNew.setTransactionDate(customerPurchaseOrder.getTransactionDate());
            salesOrderNew.setRequestDeliveryDate(customerPurchaseOrder.getTransactionDate());
            salesOrderNew.setExpiredDate(customerPurchaseOrder.getTransactionDate());
            
            salesOrderNew.setRefNo(customerPurchaseOrder.getRefNo());
            salesOrderNew.setRemark(customerPurchaseOrder.getRemark());
            
            salesOrderNew.setTotalTransactionAmount(customerPurchaseOrder.getTotalTransactionAmount());
            salesOrderNew.setDiscountPercent(customerPurchaseOrder.getDiscountPercent());
            salesOrderNew.setDiscountAmount(customerPurchaseOrder.getDiscountAmount());
            salesOrderNew.setTaxBaseAmount(customerPurchaseOrder.getTaxBaseAmount());
            salesOrderNew.setVatPercent(customerPurchaseOrder.getVatPercent());
            salesOrderNew.setVatAmount(customerPurchaseOrder.getVatAmount());
            salesOrderNew.setGrandTotalAmount(customerPurchaseOrder.getGrandTotalAmount());

            salesOrderNew.setBranch(customerPurchaseOrder.getBranch());
            salesOrderNew.setCustomer(customerPurchaseOrder.getCustomer());
            salesOrderNew.setEndUser(customerPurchaseOrder.getEndUser());
            salesOrderNew.setCurrency(customerPurchaseOrder.getCurrency());
            salesOrderNew.setSalesPerson(customerPurchaseOrder.getSalesPerson());
            salesOrderNew.setProject(customerPurchaseOrder.getProject());
            salesOrderNew.setCustomerPurchaseOrder(customerPurchaseOrder);
            salesOrderNew.setOrderType(customerPurchaseOrder.getPurchaseOrderType());
            ...
            if (!processReviseDetailSalesOrder(EnumActivity.ENUM_Activity.UPDATE, 
                    salesOrderNew,customerPurchaseOrder,listCustomerPurchaseOrderSalesQuotation,listCustomerPurchaseOrderItemDetail,
                    listCustomerPurchaseOrderAdditionalFee,listCustomerPurchaseOrderPaymentTerm,listCustomerPurchaseOrderItemDeliveryDate)) {
                hbmSession.hTransaction.rollback();
            }
    ...
    public void delete(CustomerPurchaseOrder customerPurchaseOrder, String moduleCode){
        try{
            ...
            CustomerSalesOrderDAO salesOrderDAO = new CustomerSalesOrderDAO(hbmSession);
            CustomerSalesOrder salesOrderUpdate = salesOrderDAO.getFromWoForRevise(customerPurchaseOrder.getCode());
    ...
    private boolean saveSalesOrderHeader(EnumActivity.ENUM_Activity enumActivity,CustomerPurchaseOrder customerPurchaseOrder,
            List<CustomerPurchaseOrderSalesQuotation> listCustomerPurchaseOrderSalesQuotation, 
            List<CustomerPurchaseOrderItemDetail> listCustomerPurchaseOrderItemDetail,
            List<CustomerPurchaseOrderAdditionalFee> listCustomerPurchaseOrderAdditionalFee,
            List<CustomerPurchaseOrderPaymentTerm> listCustomerPurchaseOrderPaymentTerm,
        ...
        try{
            ...
            String headerCode= salesOrderDAO.createCodeSo(enumActivity, customerPurchaseOrder);
            ...
            salesOrder.setTransactionDate(customerPurchaseOrder.getTransactionDate());
            salesOrder.setRequestDeliveryDate(customerPurchaseOrder.getTransactionDate());
            salesOrder.setExpiredDate(customerPurchaseOrder.getTransactionDate());
            
            salesOrder.setRefNo(customerPurchaseOrder.getRefNo());
            salesOrder.setRemark(customerPurchaseOrder.getRemark());
            
            salesOrder.setTotalTransactionAmount(customerPurchaseOrder.getTotalTransactionAmount());
            salesOrder.setDiscountPercent(customerPurchaseOrder.getDiscountPercent());
            salesOrder.setDiscountAmount(customerPurchaseOrder.getDiscountAmount());
            salesOrder.setTaxBaseAmount(customerPurchaseOrder.getTaxBaseAmount());
            salesOrder.setVatPercent(customerPurchaseOrder.getVatPercent());
            salesOrder.setVatAmount(customerPurchaseOrder.getVatAmount());
            salesOrder.setGrandTotalAmount(customerPurchaseOrder.getGrandTotalAmount());

            salesOrder.setBranch(customerPurchaseOrder.getBranch());
            salesOrder.setCustomer(customerPurchaseOrder.getCustomer());
            salesOrder.setEndUser(customerPurchaseOrder.getEndUser());
            salesOrder.setCurrency(customerPurchaseOrder.getCurrency());
            salesOrder.setSalesPerson(customerPurchaseOrder.getSalesPerson());
            salesOrder.setProject(customerPurchaseOrder.getProject());
            salesOrder.setCustomerPurchaseOrder(customerPurchaseOrder);
            salesOrder.setOrderType(customerPurchaseOrder.getPurchaseOrderType());
    ...
    private boolean updateSalesOrderHeader(EnumActivity.ENUM_Activity enumActivity,CustomerPurchaseOrder customerPurchaseOrder,
            List<CustomerPurchaseOrderSalesQuotation> listCustomerPurchaseOrderSalesQuotation, 
            List<CustomerPurchaseOrderItemDetail> listCustomerPurchaseOrderItemDetail,
            List<CustomerPurchaseOrderAdditionalFee> listCustomerPurchaseOrderAdditionalFee,
            List<CustomerPurchaseOrderPaymentTerm> listCustomerPurchaseOrderPaymentTerm,
...
//            CustomerSalesOrder salesOrderNew = new CustomerSalesOrder();
    ...
    private boolean processDetailSalesOrder(EnumActivity.ENUM_Activity enumActivity, CustomerSalesOrder salesOrderByCustomerPurchaseOrder,
        ...
        try{
            ...
            if(enumActivity.equals(EnumActivity.ENUM_Activity.UPDATE) || enumActivity.equals(EnumActivity.ENUM_Activity.NEW)){
                int q = 1;
                for(CustomerSalesOrderSalesQuotation salesOrderByCustomerPurchaseOrderSalesQuotation : listCustomerSalesOrderByCustomerPurchaseOrderSalesQuotation){
                ...
                int i = 1;
                for(CustomerSalesOrderItemDetail salesOrderByCustomerPurchaseOrderItemDetail : listCustomerSalesOrderByCustomerPurchaseOrderItemDetail){
                ...
                int f = 1;
                for(CustomerSalesOrderAdditionalFee salesOrderByCustomerPurchaseOrderAdditionalFee : listCustomerSalesOrderByCustomerPurchaseOrderAdditionalFee){
                ...
                int p = 1;
                for(CustomerSalesOrderPaymentTerm salesOrderByCustomerPurchaseOrderPaymentTerm : listCustomerSalesOrderByCustomerPurchaseOrderPaymentTerm){
                ...
                int d = 1;
                for(CustomerSalesOrderItemDeliveryDate salesOrderByCustomerPurchaseOrderItemDeliveryDate : listCustomerSalesOrderByCustomerPurchaseOrderItemDeliveryDate){
