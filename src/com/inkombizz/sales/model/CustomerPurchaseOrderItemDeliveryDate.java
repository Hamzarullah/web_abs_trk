...
@Entity
@Table(name = "sal_customer_purchase_order_item_delivery_date")
public class CustomerPurchaseOrderItemDeliveryDate extends BaseEntity implements Serializable {
